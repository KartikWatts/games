...
func get_spawn_position():
	...
	for i in 4:
		...
		var additional_spawn_offset = 20 * random_direction
		
		var query_parameters = PhysicsRayQueryParameters2D.create(player.global_position, spawn_position + additional_spawn_offset, 1)
